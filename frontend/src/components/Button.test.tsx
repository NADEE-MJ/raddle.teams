...
describe('Button Component', () => {
  ...
  describe('Button Variants', () => {
    ...
    test('applies secondary variant styles', () => {
      ...
      const button = screen.getByRole('button')
      expect(button).toHaveClass('bg-secondary', 'border', 'border-border', 'hover:bg-elevated', 'hover:border-accent', 'text-tx-primary')
    })
  ...
  describe('Button States', () => {
    test('handles disabled state', () => {
      ...
      expect(button).toHaveClass('disabled:opacity-50', 'disabled:cursor-not-allowed', 'disabled:active:scale-100')
    })
  ...
  describe('Custom Styling', () => {
    test('applies custom className and base classes', () => {
      ...
      expect(button).toHaveClass('rounded-md', 'cursor-pointer', 'font-medium', 'transition-all', 'duration-50', 'active:scale-90')
    })
  })
  ...
  describe('Combined Props', () => {
    ...
    test('loading overrides disabled for interaction', () => {
      render(<Button loading disabled={false}>Loading but not disabled prop</Button>)
