...
describe('Select Component', () => {
    ...
    describe('Label Rendering', () => {
        ...
        test('associates label with select using id', () => {
            render(
                <Select value='' onChange={mockOnChange} options={mockOptions} id='test-select' label='Choose option' />
            );
        ...
        test('does not show required indicator when not required', () => {
            render(
                <Select value='' onChange={mockOnChange} options={mockOptions} label='Choose option' required={false} />
            );
    ...
    describe('Select States', () => {
        test('handles disabled state', () => {
            ...
            expect(select).toHaveClass(
                ...
                'disabled:hover:border-border-light'
            );
        });
