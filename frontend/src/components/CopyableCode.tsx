...
export default function CopyableCode({
    ...
    return (
        <button
            ...
            className={`bg-green/20 text-green hover:bg-green/30 relative cursor-pointer rounded px-2 py-1 font-bold active:scale-95 transition-all duration-50 ${className}`}
            title={title}
            data-testid={dataTestId}
        >
            {code}
