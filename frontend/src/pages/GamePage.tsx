...
export default function GamePage() {
      ...
      case "progress_update":
        if (
          ...
          if (
            ...
            progressData.team_name &&
            progressData.current_word !== undefined
          ) {
  ...
  const currentClue =
    direction === "forward"
      ? teamProgress.forward_clue
      : teamProgress.backward_clue;
  const nextWordLength =
    direction === "forward"
      ? teamProgress.forward_next_length
      : teamProgress.backward_next_length;
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          ...
          <div className="flex justify-between items-center mb-6">
            <div>
              ...
              <p className="text-gray-600">
                Progress: {teamProgress.current_word_index + 1} /{" "}
                {teamProgress.total_words}
              </p>
            </div>
          ...
          {teamProgress.completed ? (
            <div className="text-center py-8">
              ...
              <p className="text-gray-600">
                Your team finished at{" "}
                {new Date(teamProgress.completed_at!).toLocaleTimeString()}
              </p>
            </div>
          ) : (
            <>
              ...
              <div className="text-center mb-8">
                ...
                <div className="text-gray-600">Current word in the chain</div>
              </div>
