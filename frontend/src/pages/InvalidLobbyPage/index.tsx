        ...
        <main className="bg-slate-100 dark:bg-slate-900 pt-4 md:p-4">
            <div className="max-w-6xl mx-auto">
                <div className="bg-white dark:bg-slate-800 rounded-lg shadow-sm p-4 md:p-8 text-center">
                    <h1 className='text-3xl font-bold mb-6 text-gray-900 dark:text-white'>Invalid Lobby Access</h1>
                    <p className='mb-6 text-gray-600 dark:text-gray-300 text-lg'>Please use a valid lobby link or join from the home page.</p>
                    <a
                        href='/'
