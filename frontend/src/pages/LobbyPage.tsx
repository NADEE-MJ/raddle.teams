                ...
                <div className="bg-white rounded-lg shadow-lg p-6">
                    ...
                    {!game && (
                        <div className="text-center py-8">
                            <p className="text-gray-600 mb-4">Waiting for admin to start the game...</p>
                    ...
                    {game && game.state === 'lobby' && (
                        <div className="text-center py-8">
                            <p className="text-gray-600 mb-4">Game created! Waiting for teams to be set up...</p>
                        </div>
                    )}
                    ...
                    <div className="mt-8">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                            {players.map((p: Player) => (
                                <div
                                    key={p.id}
                                    className={`p-3 rounded-lg border ${p.connected
                                ...
                                >
                                    <div className="flex items-center space-x-2">
                                        <div
                                            className={`w-3 h-3 rounded-full ${p.connected ? 'bg-green-500' : 'bg-gray-400'
                                                }`}
                                        ></div>
