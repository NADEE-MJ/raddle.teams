...
export default function CreateLobbyForm({ onCreateLobby, loading, contextLoading }: CreateLobbyFormProps) {
    ...
    return (
        <div className='mb-6'>
            <div className="text-gray-500 text-sm uppercase tracking-wide mb-3" data-testid="create-lobby-heading">Create New Lobby</div>
            
            <div className="mr-1 md:mr-0 mb-4 pt-2 pb-2 md:pt-3 md:pb-3 rounded-md border border-gray-300 bg-white px-4 py-3">
                <form onSubmit={handleSubmit} className='flex flex-col md:flex-row gap-3' data-testid='create-lobby-form'>
                    <input
                        ...
                        className='flex-1 px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500'
