...
const LandingLayout: React.FC = () => {
    // Landing can decide where to redirect if a user is already logged in.
    // The actual login check logic should be implemented where auth state lives.

    return (
        <div className="p-6">
            <h1 className="text-2xl font-bold mb-4">Welcome to Raddle Teams</h1>
            <Outlet />
        </div>
    );
};
